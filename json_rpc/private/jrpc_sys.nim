...
# Generated by json-serialization
...
proc readValue*(r: var JsonReader[JrpcSys], val: var RequestParamsRx)
  ...
  of JsonValueKind.Object:
    ...
    val.named = r.parseAsString()
  else:
    r.raiseUnexpectedValue("RequestParam must be either array or object, got=" & $tok)

proc writeValue*[F](w: var JsonWriter[F], val: RequestParamsRx) =
  {.error: "RequestParamsRx cannot be encoded, please use RequestParamsTx".}

proc readValue*[F](r: var JsonReader[F], val: var RequestParamsTx) =
  {.error: "RequestParamsTx cannot be decoded, please use RequestParamsRx".}
...
proc readValue*[F](r: var JsonReader[F], val: var RequestTx) =
  {.error: "RequestTx cannot be decoded, please use RequestRx".}
...
proc writeValue*[F](w: var JsonWriter[F], val: RequestRx) =
  {.error: "RequestRx cannot be encoded, please use RequestTx".}

proc readValue*[F](r: var JsonReader[F], val: var ResponseTx) =
  {.error: "ResponseTx cannot be decoded, please use ResponseRx".}
...
proc writeValue*[F](w: var JsonWriter[F], val: ResponseRx) =
  {.error: "ResponseRx cannot be encoded, please use ResponseTx".}

proc readValue*[F](r: var JsonReader[F], val: var RequestBatchTx) =
  {.error: "RequestBatchTx cannot be decoded, please use RequestBathRx".}
...
proc writeValue*[F](w: var JsonWriter[F], val: RequestBatchRx) =
  {.error: "RequestBatchRx cannot be encoded, please use RequestBatchTx".}

proc readValue*[F](r: var JsonReader[F], val: var ResponseBatchTx) =
  {.error: "ResponseBatchTx cannot be decoded, please use ResponseBathRx".}
...
proc writeValue*[F](w: var JsonWriter[F], val: ResponseBatchRx) =
  {.error: "ResponseBatchRx cannot be encoded, please use ResponseBatchTx".}

proc readValue*(r: var JsonReader[JrpcSys], val: var seq[ParamDescTx])
       {.gcsafe, raises: [IOError, SerializationError].} =
  for name in r.readObjectFields():
    val.add ParamDescTx(name: name, value: r.parseAsString())
...
proc toTx*(params: RequestParamsRx): RequestParamsTx
  ...
  of rpNamed:
    ...
    result.named = JrpcSys.decode(params.named.string, seq[ParamDescTx])
